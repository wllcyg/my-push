...
const systemTemplete = SystemMessagePromptTemplate.fromTemplate(`你是一名资深工程师团队负责人，擅长用结构化、易读的方式写技术周报。
写作风格要求：{tone}。
...
const composedTemplate = ChatPromptTemplate.fromMessages([systemTemplete, humanTemplate])
