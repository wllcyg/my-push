...
const examplePrompt = PromptTemplate.fromTemplate(`用户需求: {user_requirement}
...
async function runMain() {
    // 1. 初始化 Selector，这里我们将变量名统一为 exampleSelector
    ...
    try {
        ...
        console.log("=== 格式化后的 Few-Shot Prompt ===");
