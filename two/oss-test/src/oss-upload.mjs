...
// 初始化统一 S3 客户端 (RustFS / MinIO / Cloudflare R2 / 阿里云 OSS 通用)
const s3Client = new S3Client({
  ...
  region: 'auto', // 兼容 Cloudflare R2
});

/**
 * 文件流上传
 * @param {string} objectKey 对象路径 (如 aaa/bbb/first.png)
 * @param {ReadableStream|Buffer} stream fs可读流或Buffer
